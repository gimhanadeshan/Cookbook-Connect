        ...
        <div>
            ...
            >
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-semibold text-[#524A4E]">
                        Filters
                    </h3>
                    <button
                        onClick={handleToggleExpand}
                        className="text-[#524A4E] focus:outline-none md:hidden"
                    >
                    ...
                    <>
                        ...
                        <div className="mb-4">
                            <input
                                ...
                                className="w-full px-3 py-2 rounded-lg bg-[#FDEFF4] text-[#524A4E] focus:outline-none focus:ring-2 focus:ring-[#FFC0D3]"
                            />
                        </div>
                        <div className="mb-4">
                            <h4 className="text-sm font-medium mb-2 text-[#524A4E]">
                        ...
                        {/* <div className="mt-4">
                            <button
                                ...
                                className="bg-[#FF5C8D] text-sm text-[#524A4E] px-4 py-2 rounded-md hover:bg-[#524A4E] hover:text-[#FF5C8D] focus:outline-none"
                            >
                                Reset Filters
                            </button>
                        </div> */}
